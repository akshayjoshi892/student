...
<title>college</title>
  ...
  <table  border="2"  cellpadding="2" cellspacing="0" bgcolor="skyblue" width="40%">
      <tr><td><center><font size="+5" color="GREEN">MEETING DETAILS</center></td>
      </tr>
...
String QueryString = "SELECT * from  hod1";
...
<table bordercolor="black" border="5"  bgcolor="lightyellow"  cellpadding="0"
    ...
    <TR>
        ...
        <td><font color="green"></b><center>Meeting</center></td>
       <td><font  color="green"></b><center>Date</center></td>
        <td><font  color="green"></b><center>Time</center></td>
        <td><font  color="green"></b><center>Venue</center></td>
   <td><font  color="green"></b><center>Remark</center></td>
        </TR>
<%
while (rs.next()) {
%>
 ...
 <td> <center>  <%=rs.getString(2)%></center>
     <td></b><center><%=rs.getString(3)%></center>
