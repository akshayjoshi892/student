...
<head>
    ...
    <body bgcolor="lightgreen">
      <div>
        <form action="edithod.jsp" method="post">
...
st.executeUpdate("update hod set password='"+password+"',designation='"+designation+"',dept='"+dept+"',emailid='"+emailid+"',contact='"+contact+"' where username="+username+"");
}
catch(Exception e){
