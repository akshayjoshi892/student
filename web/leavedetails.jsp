...
<title>leavemanagament</title>
  ...
  <table  border="2"  cellpadding="2" cellspacing="0" bgcolor="skyblue" width="43%">
      <tr><td><center><font size="+5" color="GREEN"> DETAILS</center></td>
      </tr>
...
String QueryString = "SELECT * from   leaverequest";
...
<table bordercolor="black" border="5"  bgcolor="lightyellow"  cellpadding="0"
    ...
    <TR>
        ...
        <td><font color="green"></b><center>typeofleave</center></td>
      
        <TD><font color="green"></b><center>dateofrequest</center></td>
        <td><font  color="green"></b><center>leavefrom</center></td>
        <td><font  color="green"></b><center>todate</center></td>
        <td><font  color="green"></b><center>noofdays</center></td>
   <td><font  color="green"></b><center>purposeofleave </center></td>
   <td><font  color="green"></b><center>ADD </center></td>
        </TR>
...
<td><center><%=rs.getString(3)%></center>
 ...
 <td> <center>  <%=rs.getString(5)%></center>
     ...
     <td></b><center><A HREF="status.jsp">STATUS</center>
</tr>
